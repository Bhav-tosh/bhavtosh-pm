    ...
    <section className="max-w-7xl mx-auto px-4 md:px-8 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {caseStudies.map((cs, i) => (
          <div key={i} className={`mission-card doodle-border-3 bg-white doodle-shadow-lg overflow-hidden relative ${i % 2 ? 'tilt-2' : 'tilt-1'}`}>
            <div className="p-5 border-b-[3px] border-[#1a1a1a] flex items-center justify-between" style={{ backgroundColor: cs.color + '20' }}>
              <div>
                ...
                <p className="font-hand text-sm text-[#525252]">{cs.sector}</p>
              </div>
            ...
            <div className="p-5">
              ...
              <div className="mb-4">
                <div className="font-marker text-sm tracking-widest mb-2 text-[#404040]">▸ MY ROLE</div>

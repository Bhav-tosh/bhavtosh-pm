...
export default function OtherProjects() {
  ...
  return (
    <section id="other-work" className="max-w-7xl mx-auto px-4 md:px-8 py-16">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
        {otherProjects.map((p, i) => (
          ...
          <div className={`mission-card doodle-border bg-white dark:bg-[#211d18] p-5 doodle-shadow ${tilts[i]}`}>

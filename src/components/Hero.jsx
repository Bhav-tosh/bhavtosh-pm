    ...
    <section id="home" className="relative max-w-7xl mx-auto px-4 md:px-8 pt-12 md:pt-20 pb-16">
      <div className="grid md:grid-cols-2 gap-8 items-center">
        <div className="relative z-10">
          <div className="inline-flex items-center gap-2 doodle-border bg-white px-4 py-2 doodle-shadow mb-6 tilt-1">
          ...
          <p className="font-hand text-lg md:text-xl text-[#404040] mb-8 max-w-lg">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <a href="https://drive.google.com" target="_blank" rel="noopener noreferrer" className="doodle-border doodle-shadow bg-white px-6 py-3 font-marker text-lg wobble flex items-center gap-2">
        ...
        <div className="relative flex justify-center items-center">
          ...
          <div className="relative float-anim">
            ...
            <div className="absolute -right-4 md:-right-8 top-2 doodle-border-2 bg-white px-4 py-2 doodle-shadow font-hand text-sm md:text-base tilt-2 max-w-[140px]">
              Ready to ship!
              <div className="absolute -bottom-3 left-6 w-0 h-0 border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-t-[12px] border-t-[#1a1a1a]"></div>
              <div className="absolute -bottom-2 left-[26px] w-0 h-0 border-l-[7px] border-l-transparent border-r-[7px] border-r-transparent border-t-[9px] border-t-white"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 mt-16">
        {stats.map((s, i) => (
          <div key={i} className={`stat-card doodle-border bg-white p-5 doodle-shadow text-center ${i % 2 ? 'tilt-2' : 'tilt-1'}`}>
